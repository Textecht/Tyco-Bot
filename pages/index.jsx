      ...
      <img width="500" src="/img/bck.png" />
       ...
       Tyco bot ile kendi sunucunuzu yönetmeye ne dersiniz? Kendi özgür dünyanızı yaratın ve Eplenceli anların tadını çıkarın.. 
        ...
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
            ...
            <Link href={"https://discord.gg/sCWBnG4bbu"}>
              <a
                className={
...
Vote Tyco</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            ...
            <a href="https://discord.gg/sCWBnG4bbu" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
