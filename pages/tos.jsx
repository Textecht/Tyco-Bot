...
<p>⊳ Her discord sunucusu Tyco botu ücretsiz olarak kullanabilir, ücret karşılığında satılması veya pazarlanması kesinlikle yasaktır.</p>
...
<div className="py-3"></div>
<p>⊳ Belirli discord bot komutlarını kullanmak için şuna oy vermeniz gerekir: <a className="text-white" href="https://top.gg/bot//vote">Tyco</a> bot at certain intervals.</p>
</div>
    </div>
  );
}
