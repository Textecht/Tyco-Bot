...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/cqacZD8vHX",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=1017864902297256057&permissions=277028603968&scope=applications.commands%20bot",
    },
       {
      link: true,
      name: "Vote",
